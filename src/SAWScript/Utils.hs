...
import SAWScript.JavaCodebase (JavaCodebase(..), tryLookupClass)
...
lookupClass :: JavaCodebase -> Pos -> JSS.ClassName -> IO JSS.Class
...
lookupClassLegacy cb = lookupClass $ RTJarCodebase cb
...
findMethod :: JavaCodebase -> Pos -> String -> JSS.Class -> IO (JSS.Class, JSS.Method)
...
findMethodLegacy cb = findMethod $ RTJarCodebase cb
...
findField :: JavaCodebase -> Pos -> JSS.Type -> String -> ExceptT String IO JSS.FieldId
