...
{-  , prim "crucible_java_cfg"
  ...
  , prim "jvm_unspecified_field" "JVMValue -> String -> JVMSetup ()"
    (pureVal jvm_unspecified_field)
    Experimental
  ...
  , prim "jvm_unspecified_static_field" "String -> JVMSetup ()"
    (pureVal jvm_unspecified_static_field)
    Experimental
  ...
  , prim "jvm_unspecified_elem" "JVMValue -> Int -> JVMValue -> JVMSetup ()"
    (pureVal jvm_unspecified_elem)
    Experimental
