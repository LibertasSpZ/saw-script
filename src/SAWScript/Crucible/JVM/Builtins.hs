...
module SAWScript.Crucible.JVM.Builtins
    ...
    , jvm_postcond
    , jvm_precond
    , jvm_unspecified_field
    , jvm_unspecified_static_field
    , jvm_unspecified_elem
    , jvm_field_is
    , jvm_static_field_is
    , jvm_elem_is
    , jvm_array_is
...
jvm_unspecified_field ::
  ...
  String     {- ^ field name -} ->
  JVMSetupM ()
jvm_unspecified_field ptr fname = generic_field_is ptr fname Nothing
...
jvm_unspecified_static_field ::
  String {- ^ field name -} ->
  JVMSetupM ()
jvm_unspecified_static_field fname = generic_static_field_is fname Nothing
...
jvm_unspecified_elem ::
  ...
  Int        {- ^ index -} ->
  JVMSetupM ()
jvm_unspecified_elem ptr idx = generic_elem_is ptr idx Nothing
